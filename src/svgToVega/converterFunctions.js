...
import { matchObjectsInHierarchy, walkTree, stopTraversalFunction, isReference, extractReferenceId, mergeReferencedElements, } from "./utils";
import { generateCircleSpec, generateRectSpec, generatePathSpec, offsetProperties, generateImageSpec, generateGradientSpec, } from "./markUtils";
/**
...
export function convertElement(element, offsets, root, parentRef = null) {
    ...
    if (isReference(element)) {
        ...
        const referencedElements = matchObjectsInHierarchy(root, (node) => node && node.properties && node.properties.id === referenceId);
