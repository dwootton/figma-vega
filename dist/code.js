    ...
    if (msg.type === "fetch") {
        ...
        for (const sceneNode of newSelection) {
            ...
            while (!nodeStep.done) {
                ...
                const nodeStyles = extractStyles(node);
