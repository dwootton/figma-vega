...
figma.ui.onmessage = (msg) => {
    ...
    if (msg.type === "create") {
        ...
        console.log(widthMatches, heightMatches);
        const newAnnotationsLayer = figma.createComponent();
        newAnnotationsLayer.name = 'Annotations Layer';
        //capture width = 
        // capture hiehgt = 
        // match on the 
        newAnnotationsLayer.setPluginData('vegaPaddingHeight', '');
        newAnnotationsLayer.setPluginData('vegaPaddingWidth', '');
