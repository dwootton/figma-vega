    ...
    if (msg.type === "fetch") {
        ...
        for (const sceneNode of newSelection) {
            ...
            const pathSegs = paths.map((pathString) => {
                const svgPath = new _SVGPaths_js__WEBPACK_IMPORTED_MODULE_0__.default();
